...
void setup() {
  ...
  display.drawString(64, 0, "started");
  delay(1000);
  connectToServer();
  callData = "getLevels";
...
void drawFrame0() {
  ...
  display.setFont(ArialMT_Plain_24);
  display.setTextAlignment(TEXT_ALIGN_CENTER);
  display.drawString(64, 0, String(output_SOC) + "%");
  display.drawProgressBar(15, 40, 98, 10, output_SOC);
  display.display();
}
...
void drawFrame1() {
  ...
  display.drawString(64, 0, String(str));
  display.setFont(ArialMT_Plain_24);
  display.drawString(64, 35, "Volts" );
...
void drawFrame3() {
  ...
  display.setTextAlignment(TEXT_ALIGN_CENTER);
  display.drawString(15, 0, "Cell 1");
  display.drawString(15, 10, "Cell 2");
  display.drawString(15, 20, "Cell 3");
  display.drawString(15, 30, "Cell 4");
  display.drawString(15, 40, "PCB");

  display.setTextAlignment(TEXT_ALIGN_LEFT);


  display.drawString(50, 0, String(float(int(output_temps[0] * 100)) / 100));
  display.drawString(50, 10, String(float(int(output_temps[1] * 100)) / 100));
  display.drawString(50, 20, String(float(int(output_temps[2] * 100)) / 100));
  display.drawString(50, 30, String(float(int(output_temps[3] * 100)) / 100));
  display.drawString(50, 40, String(float(int(output_temps[4] * 100)) / 100));

  display.drawString(100, 0, String(float(int(output_volts[0] * 100)) / 100));
  display.drawString(100, 10, String(float(int(output_volts[1] * 100)) / 100));
  display.drawString(100, 20, String(float(int(output_volts[2] * 100)) / 100));
  display.drawString(100, 30, String(float(int(output_volts[3] * 100)) / 100));
  display.drawString(100, 40, String(int(output_volts[5])));
